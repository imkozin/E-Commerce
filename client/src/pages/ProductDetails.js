...
const ProductDetails = () => {
    ...
    if(!product) {
        return <section classNameName="h-screen flex justify-center items-center">Loading...</section>
    }
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt={title}
              className="lg:w-1/2 w-full lg:h-auto h-64 object-center rounded max-w-[200px] object-contain lg:max-w-sm"
              src={image}
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button
                  ...
                  className="flex ml-auto text-white bg-black border-0 py-2 px-6 focus:outline-none hover:text-orange-200 rounded"
                >
                  Add to cart
                </button>
